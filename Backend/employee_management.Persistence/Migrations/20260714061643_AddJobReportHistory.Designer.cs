...
namespace employee_management.Persistence.Migrations
{
    ...
    [Migration("20260714061643_AddJobReportHistory")]
    partial class AddJobReportHistory
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("employee_management.Domain.Entities.Job", b =>
                {
                    ...
                    b.Property<string>("JobRunningCode")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("employee_management.Domain.Entities.JobReportHistory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid?>("EditedByEmployeeId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("EditedByEmployeeId");

                    b.HasIndex("EditedDate");

                    b.HasIndex("IsDeleted");

                    b.HasIndex("JobId");

                    b.ToTable("JobReportHistories", (string)null);
                });
            ...
            modelBuilder.Entity("employee_management.Domain.Entities.SalesReason", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("Type", "Label", "IsDeleted")
                        .IsUnique();

                    b.ToTable("SalesReasons", (string)null);
                });
            ...
            modelBuilder.Entity("employee_management.Domain.Entities.JobReportHistory", b =>
                {
                    b.HasOne("employee_management.Domain.Entities.Employee", "EditedByEmployee")
                        .WithMany()
